...
REM
REM Generated by Vivado on Fri Apr 17 15:04:46 +0100 2026
...
echo "xvhdl --incr --relax -prj UART_baud_clock_tb_vhdl.prj"
call xvhdl  --incr --relax -prj UART_baud_clock_tb_vhdl.prj -log xvhdl.log
